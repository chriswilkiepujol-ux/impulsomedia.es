...
export function Footer() {
  ...
  return (
    <footer className="bg-[#080808] border-t border-[rgba(255,255,255,0.06)] py-[clamp(3rem,6vw,5rem)] px-[clamp(1.5rem,5vw,4rem)]">
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-12">
          ...
          <div className="max-w-[280px]">
            ...
            <p className="text-[0.85rem] text-[rgba(242,237,230,0.42)] leading-[1.6]">
              {t(
          ...
          <div className="flex flex-wrap gap-12 md:gap-16">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-[0.6rem]">
                <li>
                  <a href="#services" className="text-[0.85rem] text-[rgba(242,237,230,0.42)] no-underline transition-colors hover:text-[#f2ede6]">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-[0.6rem]">
                <li>
                  <a href="#work" className="text-[0.85rem] text-[rgba(242,237,230,0.42)] no-underline transition-colors hover:text-[#f2ede6]">
                    {t('Trabajo', 'Work')}
                  </a>
                </li>
                <li>
                  <a href="#process" className="text-[0.85rem] text-[rgba(242,237,230,0.42)] no-underline transition-colors hover:text-[#f2ede6]">
                    {t('Proceso', 'Process')}
                  </a>
                </li>
                <li>
                  <a href="#contact" className="text-[0.85rem] text-[rgba(242,237,230,0.42)] no-underline transition-colors hover:text-[#f2ede6]">
                    {t('Contacto', 'Contact')}
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-[0.6rem]">
                <li>
                  <a href="mailto:info@impulsomedia.es" className="text-[0.85rem] text-[rgba(242,237,230,0.42)] no-underline transition-colors hover:text-[#f2ede6]">
                    info@impulsomedia.es
                  </a>
                </li>
                <li>
                  <a href="https://wa.me/34680863229" className="text-[0.85rem] text-[rgba(242,237,230,0.42)] no-underline transition-colors hover:text-[#f2ede6]">
                    +34 680 863 229
                  </a>
                </li>
              </ul>
        ...
        <div className="pt-8 border-t border-[rgba(255,255,255,0.06)] flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-[0.78rem] text-[rgba(242,237,230,0.42)]">
